      ...
      <div id="publicGroups" style="display:block">
         ...
         <div id="contentPublicGroups" style="display:none;width:800px">
            ...
            <div>
              ...
              <h1>
                <a href="/hw4">
                  برای ورود به تمرین چهارم اینجا را کلیک کنید
                </a>    
              </h1>
              <h1>
                <a href="/hw5">
                  برای ورود به تمرین پنجم اینجا را کلیک کنید
                </a>    
              </h1>
              <h1>
                <a href="/hw6">
                  برای ورود به تمرین ششم اینجا را کلیک کنید
                </a>    
              </h1>
              <h1>
                <a href="/hw7">
                  برای ورود به تمرین هفتم اینجا را کلیک کنید
                </a>    
              </h1>
            </div>
   ...
   <div id="divCheckNbContestants" style="display:none">
    ...
    <div id="divLogin" style="display:none" class="dialog">
      <div class="login_box panel">
        <div class="panel-head"><b data-i18n="login_teammate"></b><b id='teammateNumber1'></b></div>
